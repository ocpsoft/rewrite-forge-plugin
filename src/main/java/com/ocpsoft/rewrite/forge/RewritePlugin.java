...
public class RewritePlugin implements Plugin
{
   ...
   public void createConfig(final PipeOut out,
            @Option(name = "providerClass") final JavaResource provider)
            throws FileNotFoundException
   {
      ...
      if (provider != null && !provider.exists()) {
         ...
         providerClass.removeImport(Override.class);

         Method<JavaClass> priority = providerClass
                  .addMethod("public int priority() { return 0; }");
      ...
      FileResource<?> service = resources
               .getResource("META-INF/services/org.ocpsoft.rewrite.config.ConfigurationProvider");
